			...
			<div class="flex flex-col items-center justify-center">
				...
				>
					...
					>
						...
						<h1 class="text-surface-900 dark:text-surface-0 font-bold text-5xl mb-2 mt-6">Error Occurred</h1>
						<span class="text-muted-color mb-8">Requested resource is not available.</span>
						<p-button label="Go to Dashboard" routerLink="/admin" severity="danger" />
					</div>
				</div>
			</div>
		</div>`,
